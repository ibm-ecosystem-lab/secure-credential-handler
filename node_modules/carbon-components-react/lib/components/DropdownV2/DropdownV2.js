  ...
  _createClass(DropdownV2, [{
    ...
    value: function render() {
      ...
      var Dropdown = _react.default.createElement(_react.default.Fragment, null, title, !inline && helper, _react.default.createElement(_downshift.default, {
        ...
        }), _react.default.createElement(_ListBox.default.Field, getButtonProps(_defineProperty({
          disabled: disabled
        }, 'aria-label', _this2.props['aria-label'] || _this2.props.ariaLabel)), _react.default.createElement("span", _extends({
