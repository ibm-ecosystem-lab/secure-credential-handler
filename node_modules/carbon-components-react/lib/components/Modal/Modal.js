...
function (_Component) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "elementOrParentIsFloatingMenu", function (target) {
      ...
      } else if (!_FeatureFlags.breakingChangesX) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "initialFocus", function (focusContainerElement) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var modalBody = _react.default.createElement("div", {
      ...
      }, passiveModal && modalButton, modalLabel && _react.default.createElement("p", {
        className: "".concat(prefix, "--modal-header__label")
      }, modalLabel), _react.default.createElement("p", {
        ...
        kind: danger && !_FeatureFlags.componentsX ? 'tertiary' : 'secondary',
