...
describe('Modal', function () {
  describe('Renders as expected', function () {
    ...
    it('should have iconDescription match Icon component description prop', function () {
      var description = !_FeatureFlags.componentsX ? mounted.find(_Icon.default).props().description : mounted.find(_.default).props()['aria-label'];
...
describe('Danger Modal', function () {
  describe('Renders as expected', function () {
    ...
    it('has correct button combination', function () {
      var modalButtons = wrapper.find('.bx--modal-footer').props().children;
      expect(modalButtons[0].props.kind).toEqual(!_FeatureFlags.componentsX ? 'tertiary' : 'secondary');
