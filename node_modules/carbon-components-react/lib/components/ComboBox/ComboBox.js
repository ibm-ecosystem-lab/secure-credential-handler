  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["className", "disabled", "id", "items", "itemToString", "itemToElement", "placeholder", "initialSelectedItem", "ariaLabel", "translateWithId", "invalid", "invalidText", "light", "type", "shouldFilterItem", "onChange", "onInputChange"]);

      var className = (0, _classnames.default)("".concat(prefix, "--form-item"), "".concat(prefix, "--combo-box"), containerClassName);
...
_defineProperty(ComboBox, "propTypes", {
   ...
   */
  ariaLabel: _propTypes.default.string // to be deprecated in v8.0.0
