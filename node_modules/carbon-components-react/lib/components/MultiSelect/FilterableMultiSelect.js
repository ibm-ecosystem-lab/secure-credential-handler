...
function (_React$Component) {
  ...
  _createClass(FilterableMultiSelect, [{
    ...
    value: function render() {
      ...
      var className = (0, _classnames.default)("".concat(prefix, "--multi-select"), "".concat(prefix, "--combo-box"), containerClassName, _defineProperty({}, "".concat(prefix, "--list-box--light"), light));
        ...
        render: function render(_ref3) {
          ...
          return _react.default.createElement(_downshift.default, {
            ...
            render: function render(_ref4) {
              ...
              return _react.default.createElement(_ListBox.default, _extends({
              ...
              }), _react.default.createElement(_ListBox.default.Field, getButtonProps(_objectSpread({
                disabled: disabled
              }, _this2.props['aria-label'] && _defineProperty({}, 'aria-label', _this2.props['aria-label']))), selectedItem.length > 0 && _react.default.createElement(_ListBox.default.Selection, {
                ...
                isOpen: isOpen
              })), isOpen && _react.default.createElement(_ListBox.default.Menu, null, _FeatureFlags.componentsX ? filterItems(items, {
                itemToString: itemToString,
                inputValue: inputValue
