...
describe('Tile', function () {
  ...
  describe('Renders expandable tile as expected', function () {
    ...
    it('displays the default tooltip for the chevron depending on state', function () {
      ...
      var collapsedDescription = wrapper.find(!_FeatureFlags.componentsX ? {
        icon: _carbonIcons.iconChevronDown
      } : _.default).getElements()[0].props[!_FeatureFlags.componentsX ? 'description' : 'aria-label'];
      ...
      var expandedDescription = wrapper.find(!_FeatureFlags.componentsX ? {
        icon: _carbonIcons.iconChevronDown
      } : _.default).getElements()[0].props[!_FeatureFlags.componentsX ? 'description' : 'aria-label'];
