        ...
        render: function render(_ref3) {
          ...
          return React.createElement(Downshift, {
            ...
            render: function render(_ref4) {
              ...
              return React.createElement(ListBox, _extends({
              ...
              }), React.createElement(ListBox.Field, getButtonProps(_objectSpread({
                disabled: disabled
              }, _this2.props['aria-label'] && _defineProperty({}, 'aria-label', _this2.props['aria-label']))), selectedItem.length > 0 && React.createElement(ListBox.Selection, {
                ...
                isOpen: isOpen
              })), isOpen && React.createElement(ListBox.Menu, null, componentsX ? filterItems(items, {
                itemToString: itemToString,
                inputValue: inputValue
