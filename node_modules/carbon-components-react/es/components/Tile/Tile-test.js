...
describe('Tile', function () {
  ...
  describe('Renders expandable tile as expected', function () {
    ...
    it('displays the default tooltip for the chevron depending on state', function () {
      ...
      var collapsedDescription = wrapper.find(!componentsX ? {
        icon: iconChevronDown
      } : ChevronDown16).getElements()[0].props[!componentsX ? 'description' : 'aria-label'];
      ...
      var expandedDescription = wrapper.find(!componentsX ? {
        icon: iconChevronDown
      } : ChevronDown16).getElements()[0].props[!componentsX ? 'description' : 'aria-label'];
